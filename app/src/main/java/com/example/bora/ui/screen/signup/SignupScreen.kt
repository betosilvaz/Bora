    ...
    Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
        Column(modifier = Modifier.fillMaxSize().safeDrawingPadding().verticalScroll(scrollState)) {
            ...
            Column(
                ...
                Text(
                    text = "É rapidinho. Preencha os campos\ne comece a explorar.",
                    fontSize = 13.sp,
            ...
            Column(
                ...
                Button(
                    ...
                    Text(text = "Concluir cadastro", fontSize = 14.sp, fontWeight = FontWeight.Medium)
                }
                Spacer(modifier = Modifier.height(14.dp))
                ...
                OutlinedButton(
                    ...
                    Text(text = "Entrar", fontSize = 14.sp, fontWeight = FontWeight.Normal)
                }
                Spacer(modifier = Modifier.height(14.dp))
                Text(
                    text = "Ao criar uma conta, você concorda com\nnosssos termos de uso e política de privacidade.",
                    fontSize = 11.sp,
                    lineHeight = 16.sp,
                    color = MaterialTheme.colorScheme.onSurface.copy(alpha = 0.4f),
